...
namespace PatientWarningApp.Tests.DataTests
{
    public class PractitionerAccountRepositoryTests
    {
        ...
        {
            //Arrange
            var pract = new PractitionerAccount { PractitionerAccountId = 1 };
            ...
            using (_context = new AppDbContext(_options))
            {
                ...
                var readResult = _accountRepository.Read(account.PractitionerAccountId);
        ...
        {
            //Arrange
            var pract = new PractitionerAccount() { PractitionerAccountId = 2, Email = "example@example.com" };
            ...
            using (_context = new AppDbContext(_options))
            {
                ...
                var result = _accountRepository.Read(pract.PractitionerAccountId);
                //Assert
                Assert.That(result.PractitionerAccountId, Is.EqualTo(2));
        ...
        public void GivenAnAccountId_ReadReturnsEntity_WithTwoPatientAccounts()
        {
            //Arrange
            var pract = new PractitionerAccount { PractitionerAccountId = 1 };
            _patientSetOne[0].PractitionerAccountId = pract.PractitionerAccountId;
            _patientSetOne[1].PractitionerAccountId = pract.PractitionerAccountId;
